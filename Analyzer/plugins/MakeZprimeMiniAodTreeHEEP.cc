...
// class declaration
//
class MakeZprimeMiniAodTreeHEEP : public edm::EDAnalyzer {
public:
  explicit MakeZprimeMiniAodTreeHEEP(const edm::ParameterSet&);
  ~MakeZprimeMiniAodTreeHEEP();
...
MakeZprimeMiniAodTreeHEEP::MakeZprimeMiniAodTreeHEEP(const edm::ParameterSet& iConfig):
...
MakeZprimeMiniAodTreeHEEP::~MakeZprimeMiniAodTreeHEEP()
{
  delete rootFile_;
}
...
void MakeZprimeMiniAodTreeHEEP::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  //==============================================
...
DEFINE_FWK_MODULE(MakeZprimeMiniAodTreeHEEP);
//=============================================================
//
//                        Start the Methods
//
...
//
//=============================================================
bool MakeZprimeMiniAodTreeHEEP::PrimaryVertex(const reco::VertexCollection &vertices)
{
  int nbGoodPv = 0;
  bool result = false;
...
bool MakeZprimeMiniAodTreeHEEP::isAncestor(const reco::Candidate* ancestor, const reco::Candidate * particle)
{
...
//
//=============================================================
void MakeZprimeMiniAodTreeHEEP::PrimaryVertexTree(const edm::Event& iEvent,const edm::EventSetup& es)
{
  int value3_ = 0;
  nbPv.clear();
  Nbdof.clear();
...
//=============================================================
void MakeZprimeMiniAodTreeHEEP::fillMET(const edm::Event& iEvent)
{
...
//
//=============================================================
void MakeZprimeMiniAodTreeHEEP::JetsTree(const edm::Event& iEvent,const edm::EventSetup& es)
{
  jet_nb.clear();
  jet_charge.clear();
  jet_et.clear();
...
//
//=============================================================
void MakeZprimeMiniAodTreeHEEP::BtaggingTree(const edm::Event& iEvent)
{
...
void MakeZprimeMiniAodTreeHEEP::fillPU(const edm::Event& iEvent){
...
// rho for isolation
void MakeZprimeMiniAodTreeHEEP::fillRho(const edm::Event& evt){
...
//
//=============================================================
void MakeZprimeMiniAodTreeHEEP::TauTree(const edm::Event& iEvent)
{
  int TausNumber=0;
  Nb_taus.clear();
  Tau_pt.clear();
