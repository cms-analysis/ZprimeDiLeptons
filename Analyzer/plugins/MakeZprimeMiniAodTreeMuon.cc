...
// class declaration
//
class MakeZprimeMiniAodTreeMuon : public edm::EDAnalyzer {
public:
  explicit MakeZprimeMiniAodTreeMuon(const edm::ParameterSet&);
  ~MakeZprimeMiniAodTreeMuon();
...
MakeZprimeMiniAodTreeMuon::MakeZprimeMiniAodTreeMuon(const edm::ParameterSet& iConfig):
...
MakeZprimeMiniAodTreeMuon::~MakeZprimeMiniAodTreeMuon()
{
  delete rootFile_;
}
...
void MakeZprimeMiniAodTreeMuon::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  //==============================================
...
DEFINE_FWK_MODULE(MakeZprimeMiniAodTreeMuon);
//=============================================================
//
//                        Start the Methods
//
...
//
//=============================================================
bool MakeZprimeMiniAodTreeMuon::PrimaryVertex(const reco::VertexCollection &vertices)
{
  int nbGoodPv = 0;
  bool result = false;
...
void MakeZprimeMiniAodTreeMuon::TriggerMatchingTree(const edm::Event& iEvent,const edm::EventSetup& es)
{
  ...
  for (unsigned int i = 0, n = triggerBits->size(); i < n; ++i) {
	...
	names.triggerName(i) != "HLT_TkMu27_v1" && names.triggerName(i) != "HLT_TkMu27_v2"  &&
        ...
        names.triggerName(i) != "HLT_TkMu27_v9" && names.triggerName(i) != "HLT_TkMu27_v10" ) continue;
...
bool MakeZprimeMiniAodTreeMuon::isAncestor(const reco::Candidate* ancestor, const reco::Candidate * particle)
{
...
//
//=============================================================
void MakeZprimeMiniAodTreeMuon::PrimaryVertexTree(const edm::Event& iEvent,const edm::EventSetup& es)
{
  int value3_ = 0;
  nbPv.clear();
  Nbdof.clear();
...
//=============================================================
void MakeZprimeMiniAodTreeMuon::fillMET(const edm::Event& iEvent)
{
...
//
//=============================================================
void MakeZprimeMiniAodTreeMuon::JetsTree(const edm::Event& iEvent,const edm::EventSetup& es)
{
  jet_nb.clear();
  jet_charge.clear();
  jet_et.clear();
...
//
//=============================================================
void MakeZprimeMiniAodTreeMuon::BtaggingTree(const edm::Event& iEvent)
{
...
void MakeZprimeMiniAodTreeMuon::fillPU(const edm::Event& iEvent){
...
// rho for isolation
void MakeZprimeMiniAodTreeMuon::fillRho(const edm::Event& evt){
...
//
//=============================================================
void MakeZprimeMiniAodTreeMuon::TauTree(const edm::Event& iEvent)
{
  int TausNumber=0;
  Nb_taus.clear();
  Tau_pt.clear();
